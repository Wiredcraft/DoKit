...
Java_com_didichuxing_doraemonkit_kit_parameter_matrix_JNIObj_doMmap(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_didichuxing_doraemonkit_kit_parameter_matrix_JNIObj_reallocTest(JNIEnv *env, jobject instance) {
    void *p = malloc(1024);
    p = realloc(p, 2048);
    // leak p
...
JNIEXPORT void JNICALL
Java_com_didichuxing_doraemonkit_kit_parameter_matrix_JNIObj_mallocTest(JNIEnv *env, jclass clazz) {
//    malloc_test();
#define LEN 20
