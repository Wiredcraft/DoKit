...
static uint32_t doraemon_imageIndexContainingAddress(const uintptr_t address)
{
...
static uintptr_t doraemon_segmentBaseOfImageIndex(const uint32_t idx)
{
...
static uintptr_t doraemon_firstCmdAfterHeader(const struct mach_header* const header)
{
    switch(header->magic)
    {
        case MH_MAGIC:
